...
import com.tutorials.springboot.main.Section14SpringBatchDBOperationApplication;

/**
 * @author Lenovo
 *
 */
@SpringBootTest(classes = Section14SpringBatchDBOperationApplication.class)
public class Section14SpringBatchDBOperationApplicationTest {
	@Disabled
	@Test
	void contextLoads() {
